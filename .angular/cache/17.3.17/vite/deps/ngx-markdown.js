import {
  DomSanitizer
} from "./chunk-HMZDFT65.js";
import {
  HttpClient
} from "./chunk-UBFZY5XG.js";
import {
  AsyncPipe,
  CommonModule,
  isPlatformBrowser
...
var ClipboardButtonComponent = class _ClipboardButtonComponent {
  ...
  static {
    this.ɵfac = function ClipboardButtonComponent_Factory(t) {
      return new (t || _ClipboardButtonComponent)();
    };
  }
  static {
...
var MarkdownService = class _MarkdownService {
  ...
  static {
    this.ɵfac = function MarkdownService_Factory(t) {
      return new (t || _MarkdownService)(ɵɵinject(CLIPBOARD_OPTIONS, 8), ɵɵinject(MARKED_EXTENSIONS, 8), ɵɵinject(MARKED_OPTIONS, 8), ɵɵinject(PLATFORM_ID), ɵɵinject(SECURITY_CONTEXT), ɵɵinject(HttpClient, 8), ɵɵinject(DomSanitizer));
    };
  }
  static {
...
var MarkdownComponent = class _MarkdownComponent {
  ...
  static {
    this.ɵfac = function MarkdownComponent_Factory(t) {
      return new (t || _MarkdownComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(MarkdownService), ɵɵdirectiveInject(ViewContainerRef));
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
var MarkdownPipe = class _MarkdownPipe {
  ...
  static {
    this.ɵfac = function MarkdownPipe_Factory(t) {
      return new (t || _MarkdownPipe)(ɵɵdirectiveInject(DomSanitizer, 16), ɵɵdirectiveInject(ElementRef, 16), ɵɵdirectiveInject(MarkdownService, 16), ɵɵdirectiveInject(ViewContainerRef, 16), ɵɵdirectiveInject(NgZone, 16));
    };
  }
  static {
    this.ɵpipe = ɵɵdefinePipe({
